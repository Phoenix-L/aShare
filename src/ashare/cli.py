...
@click.option("--no-pointer-update", is_flag=True, help="Skip updating latest/previous experiment pointers")
...
def experiment(
    ...
    try:
        result = execute_experiment_spec(
            ...
            update_pointers=not no_pointer_update,
        )
    except ValueError as exc:
