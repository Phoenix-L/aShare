...
class TushareProvider(DataProvider):
    ...
    def fetch_daily(
        ...
        """
        Fetch daily OHLCV data and merge turnover_rate from daily_basic.
    ...
    def fetch_minute30(
        ...
        """
        Fetch 30-minute OHLCV data and attach turnover_rate from daily_basic.
