...
def collect_run_results(output_root: Path) -> list[dict[str, Any]]:
    ...
    for run_dir in run_dirs:
        ...
        record = {
            ...
            "entry_score_weight_depth": params.get("entry_score_weight_depth"),
            "entry_score_weight_speed": params.get("entry_score_weight_speed"),
            "entry_score_weight_stabilization": params.get("entry_score_weight_stabilization"),
            "entry_score_weight_noise_penalty": params.get("entry_score_weight_noise_penalty"),
            "add_score_weight_depth": params.get("add_score_weight_depth"),
            "add_score_weight_speed": params.get("add_score_weight_speed"),
            "add_score_weight_stabilization": params.get("add_score_weight_stabilization"),
            "add_score_weight_noise_penalty": params.get("add_score_weight_noise_penalty"),
            ...
            "entry_shock_score_min": params.get("entry_shock_score_min", params.get("shock_score_min")),
            "entry_shock_score_max": params.get("entry_shock_score_max", params.get("shock_score_max")),
            ...
            "ladder_score_min_add": params.get("ladder_score_min_add"),
...
def _aggregate_trade_quality(trades: list[dict[str, Any]]) -> dict[str, float]:
    ...
    return {
        ...
        "avg_return_per_trade": _avg(pnl_values),
        ...
        rows.append(
            {
                ...
                "avg_return_per_trade": trade_quality["avg_return_per_trade"],
        ...
        rows.append(
            {
                ...
                **trade_quality,
                **component_averages,
                "return_diff_vs_60_80": trade_quality["avg_return_per_trade"] - baseline["avg_return_per_trade"],
