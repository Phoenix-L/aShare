...
def _capital_efficiency(total_return_simple: float, sum_trade_return: float) -> float:
    if sum_trade_return == 0.0:
        return 0.0
...
def _build_row(
    *,
    ...
    return {
        ...
        "entry_shock_score_min": _coalesce(params.get("entry_shock_score_min"), params.get("shock_score_min"), summary_row.get("entry_shock_score_min"), summary_row.get("shock_score_min")),
        "entry_shock_score_max": _coalesce(params.get("entry_shock_score_max"), params.get("shock_score_max"), summary_row.get("entry_shock_score_max"), summary_row.get("shock_score_max")),
        "shock_score_min": _coalesce(params.get("shock_score_min"), params.get("entry_shock_score_min"), summary_row.get("shock_score_min"), summary_row.get("entry_shock_score_min")),
        "shock_score_max": _coalesce(params.get("shock_score_max"), params.get("entry_shock_score_max"), summary_row.get("shock_score_max"), summary_row.get("entry_shock_score_max")),
